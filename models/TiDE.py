...
class Model(nn.Module):  
    ...
    def __init__(self, configs, bias=True,feature_encode_dim=4): 
        # feature_encode_dim is the temporalWidth in paper
    ...
    def forward(self, x_enc, x_mark_enc, x_dec, batch_y_mark):
        ...
        # x_mark_enc is the dynamic covariates described in the original paper
