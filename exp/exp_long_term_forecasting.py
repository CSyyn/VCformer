...
from utils.losses import weight_loss
...
class Exp_Long_Term_Forecast(Exp_Basic):
    ...
    def _select_criterion(self):
        if self.args.model == "DSformer":
            criterion = weight_loss(self.args.weight)
        else:
        ...
        with torch.no_grad():
            for i, (batch_x, batch_y, batch_x_mark, batch_y_mark) in enumerate(test_loader):
                ...
                if i % 100 == 0:
                    ...
                    visual(true=gt, preds=pd, name=os.path.join(
                        folder_path, str(i) + '.png'))
